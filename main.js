...
function loginForm(){
  ...
  document.getElementById("sign").style.backgroundColor="rgb(255, 242, 214)";
...
function signUpForm() {
  ...
  document.getElementById("log").style.backgroundColor = "rgb(255, 242, 214)";
  let user = document.body.getElementsByClassName("user")[0];
  ...
  //role of user
//   role.setAttribute("id", "myDropdown");
//   role.innerHTML = "Role";
//   role.appendChild(RoleButton);
//   document.getElementsByClassName("dropbtn").style.display="flex-end"
//
// role.addEventListener("click",function(){
//   let user = createElement("button");
//   let Organization = createElement("button");
//   user.setAttribute("class","d")
//   Organization.setAttribute("class","d")
